...
""" 
    ...
    jika angka kurang dari atau sama dengan 0, maka hasil yang diberikan adalah True. Kemudian,
    jika angka tersebut lebih dari 0 dan kurang dari atau sama dengan 5, maka program akan mengembalikan nilai False.
    Selanjutnya, untuk angka yang lebih besar dari 5 namun kurang dari atau sama dengan 8, hasil yang dikembalikan adalah True.
    Jika angka lebih besar dari 8 dan kurang dari atau sama dengan 11, maka nilai yang diberikan adalah False.
    Terakhir, apabila angka tersebut lebih besar dari 11, maka program akan memberikan hasil True.
...
print("=> 6.Pengabungkan angka <+++++0, 5<+++>8, dan 11++++> Output True")
print("=> 7.Pengabungkan angka 0<--->5 dan 8<--->11 Output True")
...
print("========================================================")
isCorrect = isangka0 or isangka1 and isangka2 or isangka3
